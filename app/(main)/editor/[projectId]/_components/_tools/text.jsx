...
const FONT_FAMILIES = ["Arial", "Arial Black", "Helvetica", "Times New Roman", "Courier New", "Georgia", "Verdana", "Comic Sans MS", "Impact"];
		...
		<div className="space-y-6">
			...
			<div className="space-y-4">
				<div>
					...
					<p className="text-xs text-white/70 mb-4">Click to add editable text to your canvas</p>
				</div>
				...
				<div className="border-t border-white/10 pt-6">
					...
					<div className="space-y-2 mb-4">
						...
						<div className="grid grid-cols-4 gap-1">
							{[
								...
								<Button key={align} onClick={() => applyTextAlign(align)} variant={textAlign === align ? "default" : "outline"} size="sm" className="p-2">
					...
					<div className="space-y-2 mb-4">
						...
						<div className="flex gap-2">
							...
							<Input value={textColor} onChange={(e) => applyTextColor(e.target.value)} placeholder="#000000" className="flex-1 bg-slate-700 border-white/20 text-white text-sm" />
						</div>
					</div>
